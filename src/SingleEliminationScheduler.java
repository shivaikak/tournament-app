...
public class SingleEliminationScheduler
    ...
    public List<Match> generateSchedule(
        ...
        for (
            ...
            int matchesInRound =
                teams.size()
                / (int) Math.pow(2, round);

            List<BracketMatch> roundMatches =
                new ArrayList<>();
    ...
    private void validateTeamCount(
        int teamCount
    ) {
